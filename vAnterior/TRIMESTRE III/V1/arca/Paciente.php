  ...
  <body>
    <main>
      ...
      <header>
          ...
          <a href="./Paciente.php" class="item-panel item-panel-1">
              <i class="fi-sr-head-side-thinking icon-panel"></i>
              <p href="">Ver mi cita medica agendada</p>
          </a>
        ...
        <article class="con-head">
          <section class="con-name-pag"><h2>Visualizacion de cita medica agendada</h2></section>
